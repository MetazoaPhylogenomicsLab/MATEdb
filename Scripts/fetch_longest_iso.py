...
Usage:
	In CESGA, load python 2.7 and biopython 2.7: module load python/2.7.17 biopython/1.62-python-2.7.17
	python2 fetch_longest_iso.py -i file.fasta -o output_longest.fasta -t -l
'''
